...
                <Card key={post.id} className="group hover:shadow-lg transition-shadow hover:bg-[#f9f5f0] overflow-hidden">
...
            	        />
                    <Badge className="absolute top-3 left-3 bg-[#d4b05d] text-white z-10">
