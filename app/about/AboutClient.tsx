...
                language === "fr" ? "bg-saffron-500 text-white" : "bg-saffron-100 text-saffron-800 hover:bg-saffron-200"
              }`}
            >
              FR
            </button>
...
              className={`px-3 py-1 text-sm rounded-md transition-colors ${
                language === "en" ? "bg-saffron-500 text-white" : "bg-saffron-100 text-saffron-800 hover:bg-saffron-200"
              }`}
            >
              EN
            </button>
...
              className={`px-3 py-1 text-sm rounded-md transition-colors ${
                language === "ar" ? "bg-saffron-500 text-white" : "bg-saffron-100 text-saffron-800 hover:bg-saffron-200"
              }`}
            >
              AR
            </button>
...
          <p className="font-playfair text-2xl md:text-3xl ext-[#d4b05d] mb-6">{t.subtitle}</p>
        </div>
      </section>
...
      _         <p className="font-poppins text-gray-600 text-sm">{t.values.traditionDesc}</p>
            </div>
