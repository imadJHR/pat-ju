...
// 'useRouter' is removed as it was unused
...
// --- ADDED: A specific type for the order data ---
interface OrderData {
  id: string;
  // You can expand this type with more order details later
  // e.g., customerName: string, total: number, etc.
}
...
  const [language, setLanguage] = useState<"en" | "fr" | "ar">("en")
  // --- MODIFIED: Used the OrderData interface instead of 'any' ---
  const [orderData, setOrderData] = useState<OrderData | null>(null)
  // --- MODIFIED: Removed unused 'items' variable ---
  const { getItemCount } = useCart()
  // --- MODIFIED: Removed unused 'router' variable ---
...
  }, [])
  ...
  // --- MODIFIED: Used the OrderData interface for the 'data' parameter ---
